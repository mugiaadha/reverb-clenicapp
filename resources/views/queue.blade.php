        ...
        <div class="row g-0" style="height:100vh;">
            ...
            <div id="colYoutube" class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                <iframe id="display-youtube"
                    data-src="https://www.youtube.com/embed/Hbp6A8qcqAI?autoplay=1&mute=1&loop=1&playlist=Hbp6A8qcqAI"
                    loading="lazy"
                    title="Video display"
    ...
    <script>
        ...
        (function() {
            try {
                ...
                // Store the URL in data-src so iframe is only loaded on user gesture
                iframe.dataset.src = `https://www.youtube.com/embed/${encodeURIComponent(vid)}?${q.toString()}`;
            } catch (e) {
    ...
    <script>
        ...
        (function() {
            ...
            function enableAndClose() {
                ...
                try {
                    // Lazy-load YouTube iframe when the user has given a gesture
                    const iframe = document.getElementById('display-youtube');
                    if (iframe && iframe.dataset && iframe.dataset.src) {
                        // assign src only now so the third-party player doesn't block initial load
                        iframe.src = iframe.dataset.src;
                    }
                } catch (e) {
                    console.warn('lazy-load iframe failed', e);
                }
            }
